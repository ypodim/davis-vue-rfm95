...
void loop() {
    if (packetFlag) {
        ...
        float ferr = radio.getFrequencyError();   // how far off the carrier was
        ...
        if (st == RADIOLIB_ERR_NONE) {
            ...
            if (crcRx == crc16ccitt(data, 6)) {
                ...
                Serial.print(F("dBm ferr=")); Serial.print(ferr/1000.0, 1); Serial.print(F("kHz"));
                Serial.print(F(" type=0x")); Serial.print(data[0] >> 4, HEX);
